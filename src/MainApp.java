...
public class MainApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        UIManager.put("OptionPane.background", new Color(22, 22, 22));
        UIManager.put("OptionPane.messageForeground", Color.WHITE);
        UIManager.put("Panel.background", new Color(22, 22, 22));
        UIManager.put("Button.font", fonteButton3);
        UIManager.put("Button.background", new Color(24, 24, 24));
        ...
        UIManager.put("Button.border", new LineBorder(new Color(19, 19, 19), 2));
        ...
        principalFrame.getContentPane().setBackground(new Color(22, 22, 22));
        ...
        // ==== MENU ====
            ...
            menuPanel.setBackground(new Color(24, 24, 24));
            menuPanel.setPreferredSize(new Dimension(0, 150));
            menuPanel.setBorder(new LineBorder(new Color(19, 19, 19), 2));

            // Panel Menu Cima
            JPanel menuCimaPanel = new JPanel(new BorderLayout());
            menuCimaPanel.setBackground(new Color(24, 24, 24));
            ...
            tituloMenuCima.setForeground(Color.WHITE);
            ...
            menuBaixoPanel.setBackground(new Color(24, 24, 24));
            ...
            menuBaixoFlowPanel.setBackground(new Color(24, 24, 24));
            ...
            botaoVoltarInicio.setForeground(Color.WHITE);
            ...
            // Mudar a cor com hover Início
                botaoVoltarInicio.addMouseListener(new java.awt.event.MouseAdapter() {
                    ...
                    // Sair do hover
                    @Override
                    public void mouseExited(java.awt.event.MouseEvent evt) {botaoVoltarInicio.setForeground(Color.WHITE);}
                });
        ...
        infoPrincipalPanel.setBackground(new Color(22, 22, 22));
        principalPanel.add(infoPrincipalPanel, BorderLayout.CENTER);
            ...
            infoPrincipalBorderPanel.setBackground(new Color(22, 22, 22));
            ...
            infoFlowPanel.setBackground(new Color(22, 22, 22));
            infoPrincipalBorderPanel.add(infoFlowPanel, BorderLayout.CENTER);
                ...
                botaoGeometriaBasica.setBackground(new Color(24, 24, 24));
                botaoGeometriaBasica.setForeground(Color.WHITE);
                botaoGeometriaBasica.setFocusPainted(false);
                botaoGeometriaBasica.setAlignmentX(Component.CENTER_ALIGNMENT);
                botaoGeometriaBasica.setBorder(new LineBorder(new Color(19, 19, 19), 2));
                ...
                botaoGeometriaEspacial.setBackground(new Color(24, 24, 24));
                botaoGeometriaEspacial.setForeground(Color.WHITE);
                botaoGeometriaEspacial.setFocusPainted(false);
                botaoGeometriaEspacial.setAlignmentX(Component.CENTER_ALIGNMENT);
                botaoGeometriaEspacial.setBorder(new LineBorder(new Color(19, 19, 19), 2));
                ...
                botaoMatematicaFinanceira.setBackground(new Color(24, 24, 24));
                botaoMatematicaFinanceira.setForeground(Color.WHITE);
                botaoMatematicaFinanceira.setFocusPainted(false);
                botaoMatematicaFinanceira.setAlignmentX(Component.CENTER_ALIGNMENT);
                botaoMatematicaFinanceira.setBorder(new LineBorder(new Color(19, 19, 19), 2));
            ...
            umOperandoPanel.setBackground(new Color(22, 22, 22));
                ...
                // Panel Operando 1, um Operando
                    ...
                    umOperando1Panel.setAlignmentX(Component.CENTER_ALIGNMENT);
                        ...
                        umOperando1Label.setForeground(Color.WHITE);
                        ...
                        umOperando1TextField.setForeground(Color.WHITE);
                        umOperando1TextField.setBackground(new Color(24, 24, 24));
                        umOperando1TextField.setFont(fonteCampos);
                        umOperando1TextField.setHorizontalAlignment(SwingConstants.CENTER);
                        umOperando1TextField.setBorder(new LineBorder(new Color(19, 19, 19), 2));
            ...
            doisOperandoPanel.setBackground(new Color(22, 22, 22));
                ...
                // Panel Operando 1, Dois Operandos
                    ...
                    doisOperando1Panel.setAlignmentX(Component.CENTER_ALIGNMENT);
                        ...
                        doisOperando1Label.setForeground(Color.WHITE);
                        ...
                        doisOperando1TextField.setForeground(Color.WHITE);
                        doisOperando1TextField.setBackground(new Color(24, 24, 24));
                        doisOperando1TextField.setFont(fonteCampos);
                        doisOperando1TextField.setHorizontalAlignment(SwingConstants.CENTER);
                        doisOperando1TextField.setBorder(new LineBorder(new Color(19, 19, 19), 2));
                ...
                // Panel Operando 2, Dois Operandos
                    ...
                    doisOperando2Panel.setBackground(new Color(22, 22, 22));
                    ...
                    doisOperando2Panel.setAlignmentX(Component.CENTER_ALIGNMENT);
                        ...
                        doisOperando2Label.setForeground(Color.WHITE);
                        ...
                        doisOperando2TextField.setForeground(Color.WHITE);
                        doisOperando2TextField.setBackground(new Color(24, 24, 24));
                        doisOperando2TextField.setFont(fonteCampos);
                        doisOperando2TextField.setHorizontalAlignment(SwingConstants.CENTER);
                        doisOperando2TextField.setBorder(new LineBorder(new Color(19, 19, 19), 2));
            ...
            tresOperandoPanel.setBackground(new Color(22, 22, 22));
                ...
                // Panel Operando 1, Três Operandos
                    ...
                    tresOperando1Panel.setAlignmentX(Component.CENTER_ALIGNMENT);
                        ...
                        tresOperando1Label.setForeground(Color.WHITE);
                        ...
                        tresOperando1TextField.setForeground(Color.WHITE);
                        tresOperando1TextField.setBackground(new Color(24, 24, 24));
                        tresOperando1TextField.setFont(fonteCampos);
                        tresOperando1TextField.setHorizontalAlignment(SwingConstants.CENTER);
                        tresOperando1TextField.setBorder(new LineBorder(new Color(19, 19, 19), 2));
                ...
                // Panel Operando 2, Três Operandos
                    ...
                    tresOperando2Panel.setBackground(new Color(22, 22, 22));
                    ...
                    tresOperando2Panel.setAlignmentX(Component.CENTER_ALIGNMENT);
                        ...
                        tresOperando2Label.setForeground(Color.WHITE);
                        ...
                        tresOperando2TextField.setForeground(Color.WHITE);
                        tresOperando2TextField.setBackground(new Color(24, 24, 24));
                        tresOperando2TextField.setFont(fonteCampos);
                        tresOperando2TextField.setHorizontalAlignment(SwingConstants.CENTER);
                        tresOperando2TextField.setBorder(new LineBorder(new Color(19, 19, 19), 2));
                ...
                // Panel Operando 3, Três Operandos
                    ...
                    tresOperando3Panel.setBackground(new Color(22, 22, 22));
                    ...
                    tresOperando3Panel.setAlignmentX(Component.CENTER_ALIGNMENT);
                        ...
                        tresOperando3Label.setForeground(Color.WHITE);
                        ...
                        tresOperando3TextField.setForeground(Color.WHITE);
                        tresOperando3TextField.setBackground(new Color(24, 24, 24));
                        tresOperando3TextField.setFont(fonteCampos);
                        tresOperando3TextField.setHorizontalAlignment(SwingConstants.CENTER);
                        tresOperando3TextField.setBorder(new LineBorder(new Color(19, 19, 19), 2));
        ...
        geometriaBasicaFrame.getContentPane().setBackground(new Color(22, 22, 22));
        ...
        geometriaBasicaPanel.setBackground(new Color(22, 22, 22));
        ...
        infoGeometriaBasicaPanel.setBackground(new Color(22, 22, 22));
        geometriaBasicaPanel.add(infoGeometriaBasicaPanel, BorderLayout.CENTER);
            ...
            infoGeometriaBasicaBorderPanel.setBackground(new Color(22, 22, 22));
            ...
            geometriaBasicaSelecionarOperacaoPanel.setBackground(new Color(22, 22, 22));
            botaoGeometriaEspacial.setBorder(new LineBorder(new Color(19, 19, 19), 2));
            ...
            infoGeometriaBasicaBorderPanel.add(geometriaBasicaSelecionarOperacaoPanel, BorderLayout.NORTH);
                ...
                botaoGeometriaBasicaSelecionarOperacao.setBackground(new Color(24, 24, 24));
                botaoGeometriaBasicaSelecionarOperacao.setForeground(Color.WHITE);
                botaoGeometriaBasicaSelecionarOperacao.setFocusPainted(false);
                botaoGeometriaBasicaSelecionarOperacao.setBorder(new LineBorder(new Color(19, 19, 19), 2));
            ...
            geometriaBasicaResultadoPanel.setBackground(new Color(22, 22, 22));
            geometriaBasicaResultadoPanel.setLayout(new BoxLayout(geometriaBasicaResultadoPanel, BoxLayout.Y_AXIS));
            geometriaBasicaResultadoPanel.setBorder(new LineBorder(new Color(19, 19, 19), 2));
            ...
            infoGeometriaBasicaBorderPanel.add(geometriaBasicaResultadoPanel, BorderLayout.SOUTH);
                ...
                botaoResultadoGeometriaBasica.setBackground(new Color(24, 24, 24));
                botaoResultadoGeometriaBasica.setForeground(Color.WHITE);
                ...
                botaoResultadoGeometriaBasica.setBorder(new LineBorder(new Color(19, 19, 19), 2));
                ...
                geometriaBasicaResultadoTextField.setForeground(Color.WHITE);
                geometriaBasicaResultadoTextField.setBackground(new Color(24, 24, 24));
                ...
                geometriaBasicaResultadoTextField.setBorder(new LineBorder(new Color(19, 19, 19), 2));
        ...
        geometriaEspacialFrame.getContentPane().setBackground(new Color(22, 22, 22));
        ...
        geometriaEspacialPanel.setBackground(new Color(22, 22, 22));
        ...
        infogeometriaEspacialPanel.setBackground(new Color(22, 22, 22));
        geometriaEspacialPanel.add(infogeometriaEspacialPanel, BorderLayout.CENTER);
            ...
            infoGeometriaEspacialBorderPanel.setBackground(new Color(22, 22, 22));
            ...
            geometriaEspacialSelecionarOperacaoPanel.setBackground(new Color(22, 22, 22));
            botaoGeometriaEspacial.setBorder(new LineBorder(new Color(19, 19, 19), 2));
            ...
            infoGeometriaEspacialBorderPanel.add(geometriaEspacialSelecionarOperacaoPanel, BorderLayout.NORTH);
                ...
                botaoGeometriaEspacialSelecionarOperacao.setBackground(new Color(24, 24, 24));
                botaoGeometriaEspacialSelecionarOperacao.setForeground(Color.WHITE);
                botaoGeometriaEspacialSelecionarOperacao.setFocusPainted(false);
                botaoGeometriaEspacialSelecionarOperacao.setBorder(new LineBorder(new Color(19, 19, 19), 2));
            ...
            geometriaEspacialResultadoPanel.setBackground(new Color(22, 22, 22));
            geometriaEspacialResultadoPanel.setLayout(new BoxLayout(geometriaEspacialResultadoPanel, BoxLayout.Y_AXIS));
            geometriaEspacialResultadoPanel.setBorder(new LineBorder(new Color(19, 19, 19), 2));
            ...
            infoGeometriaEspacialBorderPanel.add(geometriaEspacialResultadoPanel, BorderLayout.SOUTH);
                ...
                botaoResultadoGeometriaEspacial.setBackground(new Color(24, 24, 24));
                botaoResultadoGeometriaEspacial.setForeground(Color.WHITE);
                ...
                botaoResultadoGeometriaEspacial.setBorder(new LineBorder(new Color(19, 19, 19), 2));
                ...
                geometriaEspacialResultadoTextField.setForeground(Color.WHITE);
                geometriaEspacialResultadoTextField.setBackground(new Color(24, 24, 24));
                ...
                geometriaEspacialResultadoTextField.setBorder(new LineBorder(new Color(19, 19, 19), 2));
        ...
        matematicaFinanceiraFrame.getContentPane().setBackground(new Color(22, 22, 22));
        ...
        matematicaFinanceiraPanel.setBackground(new Color(22, 22, 22));
        ...
        infoMatematicaFinanceiraPanel.setBackground(new Color(22, 22, 22));
        matematicaFinanceiraPanel.add(infoMatematicaFinanceiraPanel, BorderLayout.CENTER);
            ...
            infoMatematicaFinanceiraBorderPanel.setBackground(new Color(22, 22, 22));
            ...
            matematicaFinanceiraSelecionarOperacaoPanel.setBackground(new Color(22, 22, 22));
            botaoMatematicaFinanceira.setBorder(new LineBorder(new Color(19, 19, 19), 2));
            ...
            infoMatematicaFinanceiraBorderPanel.add(matematicaFinanceiraSelecionarOperacaoPanel, BorderLayout.NORTH);
                ...
                botaoMatematicaFinanceiraSelecionarOperacao.setBackground(new Color(24, 24, 24));
                botaoMatematicaFinanceiraSelecionarOperacao.setForeground(Color.WHITE);
                botaoMatematicaFinanceiraSelecionarOperacao.setFocusPainted(false);
                botaoMatematicaFinanceiraSelecionarOperacao.setBorder(new LineBorder(new Color(19, 19, 19), 2));
            ...
            matematicaFinanceiraResultadoPanel.setBackground(new Color(22, 22, 22));
            matematicaFinanceiraResultadoPanel.setLayout(new BoxLayout(matematicaFinanceiraResultadoPanel, BoxLayout.Y_AXIS));
            matematicaFinanceiraResultadoPanel.setBorder(new LineBorder(new Color(19, 19, 19), 2));
            ...
            infoMatematicaFinanceiraBorderPanel.add(matematicaFinanceiraResultadoPanel, BorderLayout.SOUTH);
                ...
                botaoResultadoMatematicaFinanceira.setBackground(new Color(24, 24, 24));
                botaoResultadoMatematicaFinanceira.setForeground(Color.WHITE);
                ...
                botaoResultadoMatematicaFinanceira.setBorder(new LineBorder(new Color(19, 19, 19), 2));
                ...
                matematicaFinanceiraResultadoTextField.setForeground(Color.WHITE);
                matematicaFinanceiraResultadoTextField.setBackground(new Color(24, 24, 24));
                ...
                matematicaFinanceiraResultadoTextField.setBorder(new LineBorder(new Color(19, 19, 19), 2));
    ...
    public static void addMouseListenerMethod(JButton butao) {
        butao.addMouseListener(new java.awt.event.MouseAdapter() {
                        // Sair do Hover
                        @Override
                        public void mouseExited(java.awt.event.MouseEvent evt) {butao.setBackground(new Color(24, 24, 24));}

                        // Hover
                        @Override
                        public void mouseEntered(java.awt.event.MouseEvent evt) {butao.setBackground(new Color(20, 20, 20));}
                    });
    }
}
